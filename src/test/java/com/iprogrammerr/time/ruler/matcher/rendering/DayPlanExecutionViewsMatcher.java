...
public class DayPlanExecutionViewsMatcher extends TypeSafeMatcher<DayPlanExecutionViews> {
    ...
    private String rendered(String name) {
        ...
        params.put(DayPlanExecutionViews.DATE_TEMPLATE, formatting.date(date));
        params.put(DayPlanExecutionViews.HISTORY_TEMPLATE, history);
        ...
        params.put(DayPlanExecutionViews.ACTIVITIES_TEMPLATE, viewActivities);
