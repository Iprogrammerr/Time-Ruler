...
public class SigningInRespondentOld implements Respondent {
    ...
    public SigningInRespondentOld(DayPlanExecutionRespondent respondent, SigningInViews views, Users users,
