...
public class PasswordResetRespondentOld implements Respondent {
    ...
    public PasswordResetRespondentOld(SigningInRespondentOld respondent, Users users, UsersActualization actualization,
