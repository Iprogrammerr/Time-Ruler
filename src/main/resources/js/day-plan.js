...
document.getElementById("add").onclick = () => router.forwardWithParams(routes.activity, 
    dateTimeParams.yearMonthDayAsParams(yearMonthDay.year, yearMonthDay.month, yearMonthDay.day));